fn main() {
   ...
   println!("\nThe {} is informed by the aspiration to train electrical/Electronic Engineering
    proffesionals in the areas of design, building and maintenance of electrical control systems,",n4);
   ...
   println!("{} is aimed at developing competent, creative, innovative
    entrepreneural and ethically-minded persons, capable of creating value in the diverse fields of 
    Computer Science. ",w3);
